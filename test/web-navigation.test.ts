...
const group = {
  ...
  latest: { workflowId: 42, url: 'https://github.com/octo-org/core/actions/runs/100' },
};

test('builds a workflow page URL for the selected CI pipeline', () => {
  assert.equal(workflowWebUrl('github.com', group), 'https://github.com/octo-org/core/actions/workflows/42');
});
