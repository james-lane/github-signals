...
import { loadCiRuns, loadHistory, recordCiRuns, recordSnapshot } from './history.js';
    ...
    async key(chunk) {
        ...
        if (key === '\u001b[A' && this.contentFocused && !this.themeEditing) {
            if (this.prView)
                ...
                this.settingsSelection = (this.settingsSelection + 9) % 10;
        ...
        if (key === '\u001b[B' && this.contentFocused && !this.themeEditing) {
            if (this.prView) {
                ...
                this.settingsSelection = (this.settingsSelection + 1) % 10;
            else if (this.currentView() === 'History')
